...
int MPID_Get_contig (	origin_buf, n, target_offset, target_grank, win, 
	...
	MPI_Aint 		target_flag;
{
	...
	if (dev->sside != NULL)
		return dev->sside->Get_contig (origin_buf, n, target_offset, target_grank, win, 
									   local_flag, target_flag);
	else
...
int MPID_Get_sametype (	origin_buf, n, dtype, target_offset, target_grank, 
	...
	MPI_Aint 		target_flag;
{
	...
	if (dev->sside != NULL)
		return dev->sside->Get_sametype (origin_buf, n, dtype, target_offset, target_grank, 
										 win, local_flag, target_flag);
	else
		return MPI_ERR_UNSUPPORTED_OPERATION;
}
