...
#ifndef _2349866523447_COMM_H
#define _2349866523447_COMM_H
...
#define MPIR_HOST_PT2PT_CONTEXT   4
#define MPIR_HOST_COLL_CONTEXT    5
#define MPIR_LOCAL_PT2PT_CONTEXT  6
#define MPIR_LOCAL_COLL_CONTEXT   7
#define MPIR_ALL_PT2PT_CONTEXT    8
#define MPIR_ALL_COLL_CONTEXT     9
#define MPIR_FIRST_FREE_CONTEXT  10 
...
struct MPIR_COMMUNICATOR {
    ...
    /* "hidden" communicators for collective and onesided ops */
    struct MPIR_COMMUNICATOR *comm_coll; 
#if 0
    struct MPIR_COMMUNICATOR *comm_onesided; 
#endif
