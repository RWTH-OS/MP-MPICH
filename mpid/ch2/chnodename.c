...
/* This is the perfered form, IF IT WORKS. */
    ...
    /* instead of using he->h_name we now use utname.nodename, because this seems to produce better results
       (meaning: unique hostnames instead of "localhost" ) at LfBS, boris */
