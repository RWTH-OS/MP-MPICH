# Microsoft Developer Studio Project File - Name="ch_smi" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** NICHT BEARBEITEN **

# TARGTYPE "Win32 (x86) Dynamic-Link Library" 0x0102

CFG=ch_smi - Win32 Debug
!MESSAGE Dies ist kein gültiges Makefile. Zum Erstellen dieses Projekts mit NMAKE
!MESSAGE verwenden Sie den Befehl "Makefile exportieren" und führen Sie den Befehl
!MESSAGE 
!MESSAGE NMAKE /f "ch_smi.mak".
!MESSAGE 
!MESSAGE Sie können beim Ausführen von NMAKE eine Konfiguration angeben
!MESSAGE durch Definieren des Makros CFG in der Befehlszeile. Zum Beispiel:
!MESSAGE 
!MESSAGE NMAKE /f "ch_smi.mak" CFG="ch_smi - Win32 Debug"
!MESSAGE 
!MESSAGE Für die Konfiguration stehen zur Auswahl:
!MESSAGE 
!MESSAGE "ch_smi - Win32 Release" (basierend auf  "Win32 (x86) Dynamic-Link Library")
!MESSAGE "ch_smi - Win32 Debug" (basierend auf  "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
# ADD CPP /nologo /MD /GX /Ox /Ot /Og /Gf /Gy /I "$(DOLPHIN_BASE)\include" /I "$(SMIDIR)\include" /I "..\lfbs_common" /I ".\\" /I "..\..\include" /I "..\ch2" /I "..\util" /I "..\..\mpi-2-c++\src" /I "..\..\util" /I "..\..\src\coll" /I "C:\Programme\Microsoft SDK\Include" /I "..\..\unix2nt" /D "NDEBUG" /D "MPID_DEBUG_NONE" /D "IN_MPICH_DLL" /D "_WINDOWS" /D "HAS_VOLATILE" /D "RNDV_STATIC" /D "SINGLECOPY" /D "_MBCS" /D "USE_STDARG" /D "WIN32_LEAN_AND_MEAN" /D "WIN32" /Fr /YX /FD /c
# SUBTRACT CPP /Os
...
# ADD LINK32 $(DOLPHIN_BASE)/lib/sisci_api_md.lib ws2_32.lib kernel32.lib user32.lib rpcrt4.lib advapi32.lib /nologo /subsystem:console /dll /machine:I386 /nodefaultlib:"MSVCRTD" /def:".\mpich.def" /out:"..\..\lib\mpich.dll" /libpath:"$(SMIDIR)\lib" /libpath:"$(DOLPHIN_BASE)\lib" /link50compat /Release
...
# ADD CPP /nologo /MDd /GX /Z7 /Od /Gf /Gy /I "$(DOLPHIN_BASE)\include" /I "$(SMIDIR)\include" /I "..\lfbs_common" /I ".\\" /I "..\..\include" /I "..\ch2" /I "..\util" /I "..\..\mpi-2-c++\src" /I "C:\Programme\Microsoft SDK\Include" /I "..\..\src\coll" /I "..\..\unix2nt" /D "_DEBUG" /D "MPID_DEBUG_ALL" /D "_USRDLL" /D "MPID_STATISTICS" /D "IN_MPICH_DLL" /D "_WINDOWS" /D "HAS_VOLATILE" /D "RNDV_STATIC" /D "SINGLECOPY" /D "_MBCS" /D "USE_STDARG" /D "WIN32_LEAN_AND_MEAN" /D "WIN32" /Fr /YX /FD /GZ /c
...
# ADD LINK32 $(DOLPHIN_BASE)/lib/sisci_api_md.lib ws2_32.lib kernel32.lib user32.lib rpcrt4.lib advapi32.lib /nologo /subsystem:console /dll /incremental:no /map /debug /debugtype:both /machine:I386 /nodefaultlib:"MSVCRTD" /out:"..\..\lib\mpich.dll" /pdbtype:sept /libpath:"$(SMIDIR)\lib" /libpath:"$(DOLPHIN_BASE)\lib" /link50compat
...
# Name "ch_smi - Win32 Release"
# Name "ch_smi - Win32 Debug"
...
# ADD BASE RSC /l 0x407 /i "\home\martin\src\mp-mpich\mpid\ch_wsock2" /i "\Silke\Src.cvs\mp-mpich\mpid\ch_wsock2" /i "\home\karsten\Development\mp-mpich\mpid\ch_wsock2" /i "\home\worringen\LfBS\mp-mpich\mpid\ch_wsock2" /i "\home\users\karsten\c++\mp-mpich\mpid\ch_wsock2" /i "\home\users\karsten\c++\mp-mpich-1.2.0\MPID\ch_wsock2" /i "\home\users\karsten\c++\mp-mpich\MPID\ch_wsock2" /i "\home\worringen\LfBS\mp-mpich\MPID\ch_wsock2" /i "\home\karsten\Development\mp-mpich\MPID\ch_wsock2" /i "\Silke\Src.cvs\mp-mpich\MPID\ch_wsock2"
# ADD RSC /l 0x409 /i "\home\martin\src\mp-mpich\mpid\ch_wsock2" /i "\Silke\Src.cvs\mp-mpich\mpid\ch_wsock2" /i "\home\karsten\Development\mp-mpich\mpid\ch_wsock2" /i "\home\worringen\LfBS\mp-mpich\mpid\ch_wsock2" /i "\home\users\karsten\c++\mp-mpich\mpid\ch_wsock2" /i "\home\users\karsten\c++\mp-mpich-1.2.0\MPID\ch_wsock2" /i "\home\users\karsten\c++\mp-mpich\MPID\ch_wsock2" /i "\home\worringen\LfBS\mp-mpich\MPID\ch_wsock2" /i "\home\karsten\Development\mp-mpich\MPID\ch_wsock2" /i "\Silke\Src.cvs\mp-mpich\MPID\ch_wsock2" /d "SMI"
...
"$(ProjDir)\mpich.def" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	cl /DLIBNAME=mpich  /nologo /EP $(InputPath) >$(ProjDir)\mpich.def
