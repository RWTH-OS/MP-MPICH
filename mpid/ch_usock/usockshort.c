			      ...
			      struct MPIR_DATATYPE *dtype )
{
    ...
    MPID_USOCK_Test_device(MPID_devset->active_dev, "Eagerb_send_short");
	...
	struct MPIR_DATATYPE *dtype )
{
    ...
    MPID_USOCK_Test_device(MPID_devset->active_dev, "Eagerb_isend_short");
	...
	void         *in_pkt)
{
    ...
    MPID_USOCK_Test_device(MPID_devset->active_dev, "Eagerb_recv_short");
    ...
    if(msglen<pkt->len) {
	MPID_USOCK_ConsumeData(pkt->len-msglen,pkt->src_comm_lrank);
    }
	...
	void         *in_runex)
{
    ...
    MPID_USOCK_Test_device(MPID_devset->active_dev, "Eagerb_unxrecv_start_short");
...
MPIR_RHANDLE *runex;
{
  ...
  MPID_USOCK_Test_device(MPID_devset->active_dev, "short_cancel_recv");
	...
	void         *in_pkt)
{
    ...
    MPID_USOCK_Test_device(MPID_devset->active_dev, "Eagerb_save_short");
...
void MPID_USOCK_Eagerb_short_delete( MPID_Protocol *p)
{
    FREE( p );
}
...
MPID_Protocol *MPID_USOCK_Short_setup()
{
    ...
    MPID_USOCK_Test_device(MPID_devset->active_dev, "Short_setup");
