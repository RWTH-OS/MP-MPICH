...
/*#if !defined(SHMEM_PICKED) && defined(_WIN32)*/ /*Si*/
#if !defined(SHMEM_PICKED) && (defined(_WIN32) || defined (USE_NT2UNIX))
/* On WIN32 you can only use CreateFileMapping/MapViewOfFile to share memory */
#	define SHMEM_PICKED
#	define USE_XX_SHMALLOC
#	define p2p_shmalloc (void*)xx_shmalloc
#	define p2p_shfree xx_shfree
