/*
 * $Id: mpxgetopt.h 4391 2006-01-18 15:41:34Z tobias $
 *
 */

#ifndef __MPX_GETOPT_H_
#define __MPX_GETOPT_H_
...
int MPID_MPX_getopt(int nargc, char * const *nargv, const char *ostr); 
