...
#ifndef __MPXPACKETS_H__
#define __MPXPACKETS_H__
...
fprintf( MPID_TRACE_FILE,"[%d] %20s on %4d (type %d) at %s:%d\n", \
	 ((MPID_MPX_Data_global_type*)MPID_devset->active_dev->global_data)->MyWorldRank, name, channel, mode, __FILE__, __LINE__ ); \
