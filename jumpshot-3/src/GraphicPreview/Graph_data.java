...
public class Graph_data
{
	...
	do  {
		red_value = (int)(Math.random()*10000)%255;
		green_value = (int)(Math.random()*10000)%255;
		blue_value = (int)(Math.random()*10000)%255;

		temp_color = new Color(red_value,green_value,blue_value);
	    } while(used_colors.contains(temp_color)&&++count<5000);
