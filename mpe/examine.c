...
#if !defined(WIN32) || defined(BUILD_C)
/*
...
void FORTRAN_API mpe_print_datatype_unpack_action_ ANSI_ARGS(( int *, int *, 
						   MPI_Datatype *,
						   int *, int *, int * ));
void FORTRAN_API mpe_print_datatype_unpack_action_( fp, count, type, 
...
void FORTRAN_API mpe_print_datatype_pack_action_ ANSI_ARGS(( int *, int *, MPI_Datatype *,
						 int *, int *, int * ));
void FORTRAN_API mpe_print_datatype_pack_action_( fp, count, type, 
				        in_offset, out_offset, __ierr )
int *fp;
int *count;
MPI_Datatype *type;
