...
void FORTRAN_API mpe_seq_begin_ ( MPI_Comm *, int *, int * );

void  FORTRAN_API mpe_seq_begin_( MPI_Comm *comm, int *ng, int * __ierr )
{
...
void FORTRAN_API mpe_seq_end_ ( MPI_Comm *, int *, int * );

void  FORTRAN_API mpe_seq_end_( MPI_Comm *comm, int *ng, int *__ierr )
{
    MPE_Seq_end(*comm, *ng);
}
