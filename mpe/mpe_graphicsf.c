...
void FORTRAN_API mpe_open_graphics_ ANSI_ARGS(( MPE_XGraph *, MPI_Comm *, char *, int *, 
				    int *, int *, int *, int *, int * ));

void FORTRAN_API mpe_open_graphics_( handle, comm, display, x, y, w, h, is_collective, __ierr )
MPE_XGraph *handle;
MPI_Comm   *comm;
char       display[];
int*x,*y;
...
void FORTRAN_API mpe_capturefile_ ANSI_ARGS(( MPE_XGraph *, char *, int *, int * ));
void FORTRAN_API mpe_capturefile_( handle, fname, freq, __ierr )
MPE_XGraph*handle;
char       *fname;
int*freq;
int *__ierr;
...
void FORTRAN_API mpe_draw_point_ ANSI_ARGS(( MPE_XGraph *, int *, int *, MPE_Color *, 
				 int * ));
void FORTRAN_API mpe_draw_point_( handle, x, y, color, __ierr )
MPE_XGraph*handle;
int*x,*y;
MPE_Color*color;
int *__ierr;
...
void FORTRAN_API mpe_draw_points_ ANSI_ARGS(( MPE_XGraph *, MPE_Point *, int *, int * ));
void FORTRAN_API mpe_draw_points_( handle, points, npoints, __ierr )
MPE_XGraph*handle;
MPE_Point *points;
int*npoints;
int *__ierr;
...
void FORTRAN_API mpe_draw_line_ ANSI_ARGS(( MPE_XGraph *, int *, int *, int *, int *, 
				MPE_Color *, int * ));
void FORTRAN_API mpe_draw_line_( handle, x1, y1, x2, y2, color, __ierr )
MPE_XGraph*handle;
int*x1,*y1,*x2,*y2;
MPE_Color*color;
int *__ierr;
...
void FORTRAN_API mpe_fill_rectangle_ ANSI_ARGS(( MPE_XGraph *, int *, int *, int *, int *,
				     MPE_Color *, int * ));
void FORTRAN_API mpe_fill_rectangle_( handle, x, y, w, h, color, __ierr )
MPE_XGraph*handle;
int*x,*y,*w,*h;
MPE_Color*color;
int *__ierr;
...
void FORTRAN_API mpe_update_ ANSI_ARGS(( MPE_XGraph *, int * ));
void FORTRAN_API mpe_update_( handle, __ierr )
MPE_XGraph*handle;
int *__ierr;
{
...
void FORTRAN_API mpe_close_graphics_ ANSI_ARGS(( MPE_XGraph *, int * ));
void FORTRAN_API mpe_close_graphics_( handle, __ierr )
MPE_XGraph *handle;
int *__ierr;
{
...
void FORTRAN_API mpe_make_color_array_ ANSI_ARGS(( MPE_XGraph *, int *, MPE_Color [], 
				       int * ));
void FORTRAN_API mpe_make_color_array_( handle, ncolors, array, __ierr )
MPE_XGraph*handle;
int*ncolors;
MPE_Color  array[];
int *__ierr;
...
void FORTRAN_API mpe_num_colors_ ANSI_ARGS(( MPE_XGraph *, int *, int * ));
void FORTRAN_API mpe_num_colors_( handle, nc, __ierr )
MPE_XGraph*handle;
int        *nc;
int *__ierr;
{
...
void FORTRAN_API mpe_draw_circle_ ANSI_ARGS(( MPE_XGraph *, int *, int *, int *, 
				  MPE_Color *, int * ));
void FORTRAN_API mpe_draw_circle_( graph, centerx, centery, radius, color, __ierr )
MPE_XGraph*graph;
...
void FORTRAN_API mpe_fill_circle_ ANSI_ARGS(( MPE_XGraph *, int *, int *, int *, 
				  MPE_Color *, int * ));
void FORTRAN_API mpe_fill_circle_( graph, centerx, centery, radius, color, __ierr )
MPE_XGraph*graph;
int*centerx,*centery,*radius;
MPE_Color*color;
int *__ierr;
...
void FORTRAN_API mpe_draw_logic_ ANSI_ARGS(( MPE_XGraph *, int *, int * ));
void FORTRAN_API mpe_draw_logic_( graph, function, __ierr )
MPE_XGraph*graph;
int*function;
int *__ierr;
{
...
void FORTRAN_API mpe_line_thickness_ ANSI_ARGS(( MPE_XGraph *, int *, int * ));
void FORTRAN_API mpe_line_thickness_( graph, thickness, __ierr )
MPE_XGraph*graph;
int*thickness;
int *__ierr;
{
...
void FORTRAN_API mpe_add_rgb_color_ ANSI_ARGS(( MPE_XGraph *, int *, int *, int *, 
				    MPE_Color *, int * ));
void FORTRAN_API mpe_add_rgb_color_( graph, red, green, blue, mapping, __ierr )
MPE_XGraph*graph;
int*red,*green,*blue;
MPE_Color *mapping;
int *__ierr;
