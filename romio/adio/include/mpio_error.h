...
#define MPIR_ERR_NO_PIOFS 7 /*9*/
#define MPIR_ERR_NO_UFS 7 /*11*/
#define MPIR_ERR_NO_NFS 7/*13*/
#define MPIR_ERR_NO_HFS 7 /*15*/
#define MPIR_ERR_NO_XFS 7 /*17*/
#define MPIR_ERR_NO_SFS 7 /*19*/
#define MPIR_ERR_NO_PVFS 7/*21*/
#define MPIR_ERR_NO_SVM 7/*35*/ 
#define MPIR_ERR_NO_NTFS 7 /*37*/
#define MPIR_ERR_MULTIPLE_SPLIT_COLL 9 /*23*/
#define MPIR_ERR_NO_SPLIT_COLL 11 /*25*/
#define MPIR_ERR_ASYNC_OUTSTANDING 13 /*27*/
#define MPIR_READ_PERM 15 /*29*/
#define MPIR_PREALLOC_PERM 17 /*31*/
#define MPIR_ERR_FILETYPE 19 /*33*/
