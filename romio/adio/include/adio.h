/* 
 *   $Id: adio.h 948 2001-06-15 15:47:28Z joachim $    
 *
...
struct ADIOI_FileD {
    ...
    FD_TYPE fd_sys;          /* system file descriptor */
#ifdef XFS
...
#ifdef NTFS
    char *buf;		 /* For restarting overlapping operations we need to know the
			   actual buffer position, */
    int totransfer;	 /* the remaining number of bytes to read/write,*/
    ADIO_Offset offset;   /* and the actual offset. */
#endif
...
#define ADIO_NTFS	  	 158   /* Windows NT*/
#define ADIO_SVM                 159   /* SVMlib IO for SCI or TCP/IP */
#define ADIO_SCI                 160   /* SCI connected clusters */
