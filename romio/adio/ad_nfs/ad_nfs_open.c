/* 
 *   $Id: ad_nfs_open.c 2193 2003-06-05 11:50:38Z rainer $    
 *
...
#pragma weak ADIOI_NFS_Open = PADIOI_NFS_Open
#elif defined(HAVE_ATTRIBUTE_WEAK)
void ADIOI_NFS_Open(ADIO_File fd,
	int *error_code) __attribute__ ((weak, alias ("PADIOI_NFS_Open")));
#elif defined(HAVE_PRAGMA_HP_SEC_DEF)
#pragma _HP_SECONDARY_DEF PADIOI_NFS_Open  ADIOI_NFS_Open
#elif defined(HAVE_PRAGMA_CRI_DUP)
#pragma _CRI duplicate ADIOI_NFS_Open as PADIOI_NFS_Open
/* end of weak pragmas */
#endif
