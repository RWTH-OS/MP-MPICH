/* 
 *   $Id: ad_nfs_read.c 2193 2003-06-05 11:50:38Z rainer $    
 *
...
#pragma weak ADIOI_NFS_ReadContig = PADIOI_NFS_ReadContig
#pragma weak ADIOI_NFS_ReadStrided = PADIOI_NFS_ReadStrided
#elif defined(HAVE_ATTRIBUTE_WEAK)
void ADIOI_NFS_ReadContig(ADIO_File fd, void *buf, int count, 
                     MPI_Datatype datatype, int file_ptr_type,
		     ADIO_Offset offset, ADIO_Status *status,
			 int *error_code) __attribute__ ((weak, alias ("PADIOI_NFS_ReadContig")));
void ADIOI_NFS_ReadStrided(ADIO_File fd, void *buf, int count,
                       MPI_Datatype datatype, int file_ptr_type,
                       ADIO_Offset offset, ADIO_Status *status, int
                       *error_code) __attribute__ ((weak, alias ("PADIOI_NFS_ReadStrided")));
#elif defined(HAVE_PRAGMA_HP_SEC_DEF)
#pragma _HP_SECONDARY_DEF PADIOI_NFS_ReadContig  ADIOI_NFS_ReadContig
#pragma _HP_SECONDARY_DEF PADIOI_NFS_ReadStrided  ADIOI_NFS_ReadStrided
#elif defined(HAVE_PRAGMA_CRI_DUP)
#pragma _CRI duplicate ADIOI_NFS_ReadContig as PADIOI_NFS_ReadContig
#pragma _CRI duplicate ADIOI_NFS_ReadStrided as PADIOI_NFS_ReadStrided
/* end of weak pragmas */
#endif
