/* 
 *   $Id: ad_nfs_fcntl.c 2193 2003-06-05 11:50:38Z rainer $    
 *
...
#pragma weak ADIOI_NFS_Fcntl = PADIOI_NFS_Fcntl
#elif defined(HAVE_ATTRIBUTE_WEAK)
void ADIOI_NFS_Fcntl(ADIO_File fd, int flag, ADIO_Fcntl_t *fcntl_struct,
	int *error_code) __attribute__ ((weak, alias ("PADIOI_NFS_Fcntl")));
#elif defined(HAVE_PRAGMA_HP_SEC_DEF)
#pragma _HP_SECONDARY_DEF PADIOI_NFS_Fcntl  ADIOI_NFS_Fcntl
#elif defined(HAVE_PRAGMA_CRI_DUP)
#pragma _CRI duplicate ADIOI_NFS_Fcntl as PADIOI_NFS_Fcntl
/* end of weak pragmas */
#endif
