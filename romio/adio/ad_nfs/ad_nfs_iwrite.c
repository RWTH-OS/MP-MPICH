/* 
 *   $Id: ad_nfs_iwrite.c 2193 2003-06-05 11:50:38Z rainer $    
 *
...
#pragma weak ADIOI_NFS_IwriteContig = PADIOI_NFS_IwriteContig
#pragma weak ADIOI_NFS_IwriteStrided = PADIOI_NFS_IwriteStrided
#elif defined(HAVE_ATTRIBUTE_WEAK)
void ADIOI_NFS_IwriteContig(ADIO_File fd, void *buf, int count,
		MPI_Datatype datatype, int file_ptr_type,
		ADIO_Offset offset, ADIO_Request *request,
		int *error_code)   __attribute__ ((weak, alias ("PADIOI_NFS_IwriteContig")));
void ADIOI_NFS_IwriteStrided(ADIO_File fd, void *buf, int count, 
		MPI_Datatype datatype, int file_ptr_type,
		ADIO_Offset offset, ADIO_Request *request, int
		*error_code) __attribute__ ((weak, alias ("PADIOI_NFS_IwriteStrided")));
#elif defined(HAVE_PRAGMA_HP_SEC_DEF)
#pragma _HP_SECONDARY_DEF PADIOI_NFS_IwriteContig  ADIOI_NFS_IwriteContig
#pragma _HP_SECONDARY_DEF PADIOI_NFS_IwriteStrided  ADIOI_NFS_IwriteStrided
#elif defined(HAVE_PRAGMA_CRI_DUP)
#pragma _CRI duplicate ADIOI_NFS_IwriteContig as PADIOI_NFS_IwriteContig
#pragma _CRI duplicate ADIOI_NFS_IwriteStrided as PADIOI_NFS_IwriteStrided
/* end of weak pragmas */
#endif
