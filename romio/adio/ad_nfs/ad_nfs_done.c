/* 
 *   $Id: ad_nfs_done.c 2193 2003-06-05 11:50:38Z rainer $    
 *
...
#pragma weak ADIOI_NFS_ReadDone = PADIOI_NFS_ReadDone
#pragma weak ADIOI_NFS_WriteDone = PADIOI_NFS_WriteDone
#elif defined(HAVE_ATTRIBUTE_WEAK)
int ADIOI_NFS_ReadDone(ADIO_Request *request, ADIO_Status *status,
	int *error_code) __attribute__ ((weak, alias ("PADIOI_NFS_ReadDone")));
int ADIOI_NFS_WriteDone(ADIO_Request *request, ADIO_Status *status,
	int *error_code) __attribute__ ((weak, alias ("PADIOI_NFS_WriteDone")));
#elif defined(HAVE_PRAGMA_HP_SEC_DEF)
#pragma _HP_SECONDARY_DEF PADIOI_NFS_ReadDone  ADIOI_NFS_ReadDone
#pragma _HP_SECONDARY_DEF PADIOI_NFS_WriteDone  ADIOI_NFS_WriteDone
#elif defined(HAVE_PRAGMA_CRI_DUP)
#pragma _CRI duplicate ADIOI_NFS_ReadDone as PADIOI_NFS_ReadDone
#pragma _CRI duplicate ADIOI_NFS_WriteDone as PADIOI_NFS_WriteDone
/* end of weak pragmas */
#endif
