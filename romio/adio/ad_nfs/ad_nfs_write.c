/* 
 *   $Id: ad_nfs_write.c 2193 2003-06-05 11:50:38Z rainer $    
 *
...
#pragma weak ADIOI_NFS_WriteContig = PADIOI_NFS_WriteContig
#pragma weak ADIOI_NFS_WriteStrided = PADIOI_NFS_WriteStrided
#elif defined(HAVE_ATTRIBUTE_WEAK)
void ADIOI_NFS_WriteContig(ADIO_File fd, void *buf, int count, 
                     MPI_Datatype datatype, int file_ptr_type,
		     ADIO_Offset offset, ADIO_Status *status,
			 int *error_code) __attribute__ ((weak, alias ("PADIOI_NFS_WriteContig")));
void ADIOI_NFS_WriteStrided(ADIO_File fd, void *buf, int count,
                       MPI_Datatype datatype, int file_ptr_type,
                       ADIO_Offset offset, ADIO_Status *status, int
                       *error_code) __attribute__ ((weak, alias ("PADIOI_NFS_WriteStrided")));
#elif defined(HAVE_PRAGMA_HP_SEC_DEF)
#pragma _HP_SECONDARY_DEF PADIOI_NFS_WriteContig  ADIOI_NFS_WriteContig
#pragma _HP_SECONDARY_DEF PADIOI_NFS_WriteStrided  ADIOI_NFS_WriteStrided
#elif defined(HAVE_PRAGMA_CRI_DUP)
#pragma _CRI duplicate ADIOI_NFS_WriteContig as PADIOI_NFS_WriteContig
#pragma _CRI duplicate ADIOI_NFS_WriteStrided as PADIOI_NFS_WriteStrided
/* end of weak pragmas */
#endif
