/* 
 *   $Id: ad_nfs_getsh.c 2193 2003-06-05 11:50:38Z rainer $    
 *
...
#pragma weak ADIOI_NFS_Get_shared_fp = PADIOI_NFS_Get_shared_fp
#elif defined(HAVE_ATTRIBUTE_WEAK)
void ADIOI_NFS_Get_shared_fp(ADIO_File fd, int incr, ADIO_Offset *shared_fp, 
			 int *error_code) __attribute__ ((weak, alias ("PADIOI_NFS_Get_shared_fp")));
#elif defined(HAVE_PRAGMA_HP_SEC_DEF)
#pragma _HP_SECONDARY_DEF PADIOI_NFS_Get_shared_fp  ADIOI_NFS_Get_shared_fp
#elif defined(HAVE_PRAGMA_CRI_DUP)
#pragma _CRI duplicate ADIOI_NFS_Get_shared_fp as PADIOI_NFS_Get_shared_fp
/* end of weak pragmas */
#endif
