/* 
 *   $Id: ad_nfs_wait.c 2193 2003-06-05 11:50:38Z rainer $    
 *
...
#pragma weak ADIOI_NFS_ReadComplete = PADIOI_NFS_ReadComplete
#pragma weak ADIOI_NFS_WriteComplete = PADIOI_NFS_WriteComplete
#elif defined(HAVE_ATTRIBUTE_WEAK)
void ADIOI_NFS_ReadComplete(ADIO_Request *request, ADIO_Status *status,
	int *error_code) __attribute__ ((weak, alias ("PADIOI_NFS_ReadComplete")));
void ADIOI_NFS_WriteComplete(ADIO_Request *request, ADIO_Status *status,
	int *error_code) __attribute__ ((weak, alias ("PADIOI_NFS_WriteComplete")));
#elif defined(HAVE_PRAGMA_HP_SEC_DEF)
#pragma _HP_SECONDARY_DEF PADIOI_NFS_ReadComplete  ADIOI_NFS_ReadComplete
#pragma _HP_SECONDARY_DEF PADIOI_NFS_WriteComplete  ADIOI_NFS_WriteComplete
#elif defined(HAVE_PRAGMA_CRI_DUP)
#pragma _CRI duplicate ADIOI_NFS_ReadComplete as PADIOI_NFS_ReadComplete
#pragma _CRI duplicate ADIOI_NFS_WriteComplete as PADIOI_NFS_WriteComplete
/* end of weak pragmas */
#endif
