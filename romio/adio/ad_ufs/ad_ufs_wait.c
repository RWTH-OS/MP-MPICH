/* 
 *   $Id: ad_ufs_wait.c 2193 2003-06-05 11:50:38Z rainer $    
 *
...
#pragma weak ADIOI_UFS_ReadComplete = PADIOI_UFS_ReadComplete
#pragma weak ADIOI_UFS_WriteComplete = PADIOI_UFS_WriteComplete
#elif defined(HAVE_ATTRIBUTE_WEAK)
void ADIOI_UFS_ReadComplete(ADIO_Request *request, ADIO_Status *status,
	int *error_code) __attribute__ ((weak, alias ("PADIOI_UFS_ReadComplete")));
void ADIOI_UFS_WriteComplete(ADIO_Request *request, ADIO_Status *status,
	int *error_code) __attribute__ ((weak, alias ("PADIOI_UFS_WriteComplete")));
#elif defined(HAVE_PRAGMA_HP_SEC_DEF)
#pragma _HP_SECONDARY_DEF PADIOI_UFS_ReadComplete  ADIOI_UFS_ReadComplete
#pragma _HP_SECONDARY_DEF PADIOI_UFS_WriteComplete  ADIOI_UFS_WriteComplete
#elif defined(HAVE_PRAGMA_CRI_DUP)
#pragma _CRI duplicate ADIOI_UFS_ReadComplete as PADIOI_UFS_ReadComplete
#pragma _CRI duplicate ADIOI_UFS_WriteComplete as PADIOI_UFS_WriteComplete
/* end of weak pragmas */
#endif
