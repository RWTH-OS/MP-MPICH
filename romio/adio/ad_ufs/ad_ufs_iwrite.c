/* 
 *   $Id: ad_ufs_iwrite.c 2193 2003-06-05 11:50:38Z rainer $    
 *
...
#pragma weak ADIOI_UFS_IwriteContig = PADIOI_UFS_IwriteContig
#pragma weak ADIOI_UFS_IwriteStrided = PADIOI_UFS_IwriteStrided
#elif defined(HAVE_ATTRIBUTE_WEAK)
void ADIOI_UFS_IwriteContig(ADIO_File fd, void *buf, int count, 
	MPI_Datatype datatype, int file_ptr_type,
	ADIO_Offset offset, ADIO_Request *request,
	int *error_code) __attribute__ ((weak, alias ("PADIOI_UFS_IwriteContig")));
void ADIOI_UFS_IwriteStrided(ADIO_File fd, void *buf, int count, 
	MPI_Datatype datatype, int file_ptr_type,
	ADIO_Offset offset, ADIO_Request *request, int
	*error_code) __attribute__ ((weak, alias ("PADIOI_UFS_IwriteStrided")));
#elif defined(HAVE_PRAGMA_HP_SEC_DEF)
#pragma _HP_SECONDARY_DEF PADIOI_UFS_IwriteContig  ADIOI_UFS_IwriteContig
#pragma _HP_SECONDARY_DEF PADIOI_UFS_IwriteStrided  ADIOI_UFS_IwriteStrided
#elif defined(HAVE_PRAGMA_CRI_DUP)
#pragma _CRI duplicate ADIOI_UFS_IwriteContig as PADIOI_UFS_IwriteContig
#pragma _CRI duplicate ADIOI_UFS_IwriteStrided as PADIOI_UFS_IwriteStrided
/* end of weak pragmas */
#endif
