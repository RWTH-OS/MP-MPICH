/* 
 *   $Id: ad_ufs_done.c 2193 2003-06-05 11:50:38Z rainer $    
 *
...
#pragma weak ADIOI_UFS_ReadDone = PADIOI_UFS_ReadDone
#pragma weak ADIOI_UFS_WriteDone = PADIOI_UFS_WriteDone
#elif defined(HAVE_ATTRIBUTE_WEAK)
int ADIOI_UFS_ReadDone(ADIO_Request *request, ADIO_Status *status,
	int *error_code) __attribute__ ((weak, alias ("PADIOI_UFS_ReadDone")));
int ADIOI_UFS_WriteDone(ADIO_Request *request, ADIO_Status *status,
	int *error_code) __attribute__ ((weak, alias ("PADIOI_UFS_WriteDone")));
#elif defined(HAVE_PRAGMA_HP_SEC_DEF)
#pragma _HP_SECONDARY_DEF PADIOI_UFS_ReadDone  ADIOI_UFS_ReadDone
#pragma _HP_SECONDARY_DEF PADIOI_UFS_WriteDone  ADIOI_UFS_WriteDone
#elif defined(HAVE_PRAGMA_CRI_DUP)
#pragma _CRI duplicate ADIOI_UFS_ReadDone as PADIOI_UFS_ReadDone
#pragma _CRI duplicate ADIOI_UFS_WriteDone as PADIOI_UFS_WriteDone
/* end of weak pragmas */
#endif
