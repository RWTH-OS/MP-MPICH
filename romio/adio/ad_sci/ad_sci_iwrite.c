/* 
 *   $Id: ad_sci_iwrite.c,v 1.1 2001/01/03 17:34:53 joachim Exp $    
 *
 *
 *
 */
                ...
                ADIO_Offset offset, ADIO_Request *request, int *error_code)  
{
    ...
    static char myname[] = "ADIOI_SCI_IWRITECONTIG";
#endif
#endif
    ...
    *request = ADIOI_Malloc_request();
    ...
    ADIOI_SCI_WriteContig(fd, buf, len, MPI_BYTE, file_ptr_type, offset, 
			  &status, error_code);  
    (*request)->queued = 0;
    ...
    err = ADIOI_SCI_aio(fd, buf, len, offset, 1, &((*request)->handle));
...
/* call the blocking version. It is faster because it does data sieving. */
    ADIOI_SCI_WriteStrided(fd, buf, count, datatype, file_ptr_type, 
