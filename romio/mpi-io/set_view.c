/* 
 *   $Id: set_view.c 2193 2003-06-05 11:50:38Z rainer $    
 *
...
int MPI_File_set_view(MPI_File fh, MPI_Offset disp, MPI_Datatype etype,
	...
	MPI_Info info)__attribute__ ((weak, alias ("PMPI_File_set_view")));
		 ...
		 MPI_Datatype filetype, char *datarep, MPI_Info info)
{
	...
	error_code = MPIR_Err_setmsg(MPI_ERR_UNSUPPORTED_DATAREP, 
               MPIR_ERR_NOT_NATIVE_DATAREP, myname, (char *) 0, (char *) 0,datarep);
	return ADIOI_Error(fh, error_code, myname);	    
#endif
    }
