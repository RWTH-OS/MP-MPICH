/* 
 *   $Id: set_infof.c 3744 2005-07-18 10:55:08Z georg $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPI_FILE_SET_INFO (MPI_Fint *fh, MPI_Fint *info, int *ierr ) 
	__attribute__ ((weak, alias ("PMPI_FILE_SET_INFO")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpi_file_set_info__ (MPI_Fint *fh, MPI_Fint *info, int *ierr ) 		__attribute__ ((weak, alias ("pmpi_file_set_info__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpi_file_set_info (MPI_Fint *fh, MPI_Fint *info, int *ierr ) 
	__attribute__ ((weak, alias ("pmpi_file_set_info")));
#else
void FORTRAN_API mpi_file_set_info_ (MPI_Fint *fh, MPI_Fint *info, int *ierr ) 
	__attribute__ ((weak, alias ("pmpi_file_set_info_")));
#endif
