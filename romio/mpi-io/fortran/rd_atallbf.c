/* 
 *   $Id: rd_atallbf.c 3744 2005-07-18 10:55:08Z georg $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPI_FILE_READ_AT_ALL_BEGIN (MPI_Fint *fh,MPI_Offset *offset,void *buf,
                         int *count,MPI_Fint *datatype, int *ierr ) 
			 __attribute__ ((weak, alias ("PMPI_FILE_READ_AT_ALL_BEGIN")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpi_file_read_at_all_begin__ (MPI_Fint *fh,MPI_Offset *offset,void *buf,
                         int *count,MPI_Fint *datatype, int *ierr ) 
			 __attribute__ ((weak, alias ("pmpi_file_read_at_all_begin__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpi_file_read_at_all_begin (MPI_Fint *fh,MPI_Offset *offset,void *buf,
                         int *count,MPI_Fint *datatype, int *ierr ) 
			 __attribute__ ((weak, alias ("pmpi_file_read_at_all_begin")));
...
void FORTRAN_API mpi_file_read_at_all_begin_ (MPI_Fint *fh,MPI_Offset *offset,void *buf,
                         int *count,MPI_Fint *datatype, int *ierr ) 
			 __attribute__ ((weak, alias ("pmpi_file_read_at_all_begin_")));
#endif
