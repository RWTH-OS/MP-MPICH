/* 
 *   $Id: iotestf.c 3744 2005-07-18 10:55:08Z georg $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPIO_TEST (MPI_Fint *request,int *flag,MPI_Status *status, int *ierr ) 	__attribute__ ((weak, alias ("PMPIO_TEST")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpio_test__ (MPI_Fint *request,int *flag,MPI_Status *status, int *ierr ) 	__attribute__ ((weak, alias ("pmpio_test__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpio_test (MPI_Fint *request,int *flag,MPI_Status *status, int *ierr ) 	__attribute__ ((weak, alias ("pmpio_test")));
#else
void FORTRAN_API mpio_test_ (MPI_Fint *request,int *flag,MPI_Status *status, int *ierr ) 	__attribute__ ((weak, alias ("pmpio_test_")));
#endif
...
void FORTRAN_API mpio_test_(MPI_Fint *request,int *flag,MPI_Status *status, int *ierr )
{
    MPIO_Request req_c;
