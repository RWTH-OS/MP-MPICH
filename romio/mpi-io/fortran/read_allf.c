/* 
 *   $Id: read_allf.c 3732 2005-07-14 14:11:52Z tobias $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPI_FILE_READ_ALL (MPI_Fint *fh,void *buf,int *count,
     MPI_Fint *datatype,MPI_Status *status, int *ierr ) __attribute__ ((weak, alias ("PMPI_FILE_READ_ALL")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpi_file_read_all__ (MPI_Fint *fh,void *buf,int *count,
     MPI_Fint *datatype,MPI_Status *status, int *ierr ) __attribute__ ((weak, alias ("pmpi_file_read_all__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpi_file_read_all (MPI_Fint *fh,void *buf,int *count,
     MPI_Fint *datatype,MPI_Status *status, int *ierr ) __attribute__ ((weak, alias ("pmpi_file_read_all")));
#else
void FORTRAN_API mpi_file_read_all_ (MPI_Fint *fh,void *buf,int *count,
     MPI_Fint *datatype,MPI_Status *status, int *ierr ) __attribute__ ((weak, alias ("pmpi_file_read_all_")));
#endif
