/* 
 *   $Id: write_ordef.c 3744 2005-07-18 10:55:08Z georg $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPI_FILE_WRITE_ORDERED_END (MPI_Fint *fh,void *buf, 
	MPI_Status *status, int *ierr ) 
	__attribute__ ((weak, alias ("PMPI_FILE_WRITE_ORDERED_END")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpi_file_write_ordered_end__ (MPI_Fint *fh,void *buf, 
	MPI_Status *status, int *ierr ) 
	__attribute__ ((weak, alias ("pmpi_file_write_ordered_end__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpi_file_write_ordered_end (MPI_Fint *fh,void *buf, 
	MPI_Status *status, int *ierr ) 
	__attribute__ ((weak, alias ("pmpi_file_write_ordered_end")));
#else
void FORTRAN_API mpi_file_write_ordered_end_ (MPI_Fint *fh,void *buf, 
	MPI_Status *status, int *ierr ) 
	__attribute__ ((weak, alias ("pmpi_file_write_ordered_end_")));
#endif
...
void FORTRAN_API mpi_file_write_ordered_end_(MPI_Fint *fh,void *buf,MPI_Status *status, int *ierr ){
    MPI_File fh_c;
