/* 
 *   $Id: rd_atallef.c 3744 2005-07-18 10:55:08Z georg $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPI_FILE_READ_AT_ALL_END (MPI_Fint *fh,void *buf,
	MPI_Status *status, int *ierr ) 
	__attribute__ ((weak, alias ("PMPI_FILE_READ_AT_ALL_END")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpi_file_read_at_all_end__ (MPI_Fint *fh,void *buf, 
	MPI_Status *status, int *ierr ) 
	__attribute__ ((weak, alias ("pmpi_file_read_at_all_end__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpi_file_read_at_all_end (MPI_Fint *fh,void *buf, 
	MPI_Status *status, int *ierr ) 
	__attribute__ ((weak, alias ("pmpi_file_read_at_all_end")));
#else
void FORTRAN_API mpi_file_read_at_all_end_ (MPI_Fint *fh,void *buf, 
	MPI_Status *status, int *ierr ) 
	__attribute__ ((weak, alias ("pmpi_file_read_at_all_end_")));
#endif
