/* 
 *   $Id: set_sizef.c 3732 2005-07-14 14:11:52Z tobias $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPI_FILE_SET_SIZE (MPI_Fint *fh,MPI_Offset *size, int *ierr ) __attribute__ ((weak, alias ("PMPI_FILE_SET_SIZE")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpi_file_set_size__ (MPI_Fint *fh,MPI_Offset *size, int *ierr ) __attribute__ ((weak, alias ("pmpi_file_set_size__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpi_file_set_size (MPI_Fint *fh,MPI_Offset *size, int *ierr ) __attribute__ ((weak, alias ("pmpi_file_set_size")));
#else
void FORTRAN_API mpi_file_set_size_ (MPI_Fint *fh,MPI_Offset *size, int *ierr ) __attribute__ ((weak, alias ("pmpi_file_set_size_")));
#endif
...
void FORTRAN_API mpi_file_set_size_(MPI_Fint *fh,MPI_Offset *size, int *ierr )
{
    MPI_File fh_c;
