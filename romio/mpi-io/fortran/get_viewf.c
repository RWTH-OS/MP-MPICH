/* 
 *   $Id: get_viewf.c 3732 2005-07-14 14:11:52Z tobias $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPI_FILE_GET_VIEW (MPI_Fint *fh,MPI_Offset *disp,MPI_Datatype *etype,
   MPI_Datatype *filetype,char *datarep, int *ierr, int str_len ) __attribute__ ((weak, alias ("PMPI_FILE_GET_VIEW")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpi_file_get_view__ (MPI_Fint *fh,MPI_Offset *disp,MPI_Datatype *etype,
   MPI_Datatype *filetype,char *datarep, int *ierr, int str_len ) __attribute__ ((weak, alias ("pmpi_file_get_view__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpi_file_get_view (MPI_Fint *fh,MPI_Offset *disp,MPI_Datatype *etype,
   MPI_Datatype *filetype,char *datarep, int *ierr, int str_len ) __attribute__ ((weak, alias ("pmpi_file_get_view")));
#else
void FORTRAN_API mpi_file_get_view_ (MPI_Fint *fh,MPI_Offset *disp,MPI_Datatype *etype,
   MPI_Datatype *filetype,char *datarep, int *ierr, int str_len ) __attribute__ ((weak, alias ("pmpi_file_get_view_")));
#endif
...
void FORTRAN_API mpi_file_get_view_(MPI_Fint *fh,MPI_Offset *disp,MPI_Datatype *etype,
   MPI_Datatype *filetype,char *datarep, int str_len, int *ierr)
{
#else
void FORTRAN_API mpi_file_get_view_(MPI_Fint *fh,MPI_Offset *disp,MPI_Datatype *etype,
...
#ifdef MP_MPICH
	*ierr = MPI_ERR_ARG;
	MPIR_ERROR(MPIR_COMM_WORLD,MPI_ERR_OTHER,"MPI_File_get_view: datarep is an invalid address");
	return;
#else
        FPRINTF(stderr, "MPI_File_get_view: datarep is an invalid address\n");
        MPI_Abort(MPI_COMM_WORLD, 1);
