/* 
 *   $Id: iwritef.c 3744 2005-07-18 10:55:08Z georg $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPI_FILE_IWRITE (MPI_Fint *fh,void *buf,int *count,
                    MPI_Fint *datatype,MPI_Fint *request, int *ierr ) 
		    __attribute__ ((weak, alias ("PMPI_FILE_IWRITE")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpi_file_iwrite__ (MPI_Fint *fh,void *buf,int *count,
                    MPI_Fint *datatype,MPI_Fint *request, int *ierr ) 
		    __attribute__ ((weak, alias ("pmpi_file_iwrite__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpi_file_iwrite (MPI_Fint *fh,void *buf,int *count,
                    MPI_Fint *datatype,MPI_Fint *request, int *ierr ) 
		    __attribute__ ((weak, alias ("pmpi_file_iwrite")));
...
void FORTRAN_API mpi_file_iwrite_ (MPI_Fint *fh,void *buf,int *count,
                    MPI_Fint *datatype,MPI_Fint *request, int *ierr ) 
		    __attribute__ ((weak, alias ("pmpi_file_iwrite_")));
#endif
