/* 
 *   $Id: write_allbf.c 3744 2005-07-18 10:55:08Z georg $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPI_FILE_WRITE_ALL_BEGIN (MPI_Fint *fh,void *buf,int *count,
                       MPI_Fint *datatype, int *ierr ) 
		       __attribute__ ((weak, alias ("PMPI_FILE_WRITE_ALL_BEGIN")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpi_file_write_all_begin__ (MPI_Fint *fh,void *buf,int *count,
                       MPI_Fint *datatype, int *ierr ) 
		       __attribute__ ((weak, alias ("pmpi_file_write_all_begin__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpi_file_write_all_begin (MPI_Fint *fh,void *buf,int *count,
                       MPI_Fint *datatype, int *ierr ) 
		       __attribute__ ((weak, alias ("pmpi_file_write_all_begin")));
#else
void FORTRAN_API mpi_file_write_all_begin_ (MPI_Fint *fh,void *buf,int *count,
                       MPI_Fint *datatype, int *ierr ) 
		       __attribute__ ((weak, alias ("pmpi_file_write_all_begin_")));
#endif
