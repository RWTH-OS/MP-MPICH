/* 
 *   $Id: get_posn_shf.c 3744 2005-07-18 10:55:08Z georg $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPI_FILE_GET_POSITION_SHARED (MPI_Fint *fh, MPI_Offset *offset, 
	int *ierr ) __attribute__ ((weak, alias ("PMPI_FILE_GET_POSITION_SHARED")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpi_file_get_position_shared__ (MPI_Fint *fh, MPI_Offset *offset, 
	int *ierr) __attribute__ ((weak, alias ("pmpi_file_get_position_shared__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpi_file_get_position_shared (MPI_Fint *fh, MPI_Offset *offset, 
	int *ierr ) __attribute__ ((weak, alias ("pmpi_file_get_position_shared")));
#else
void FORTRAN_API mpi_file_get_position_shared_ (MPI_Fint *fh, MPI_Offset *offset, 
	int *ierr ) __attribute__ ((weak, alias ("pmpi_file_get_position_shared_")));
#endif
