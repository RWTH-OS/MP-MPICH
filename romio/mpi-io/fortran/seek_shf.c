/* 
 *   $Id: seek_shf.c 3744 2005-07-18 10:55:08Z georg $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPI_FILE_SEEK_SHARED (MPI_Fint *fh,MPI_Offset *offset,int *whence, int *ierr ) __attribute__ ((weak, alias ("PMPI_FILE_SEEK_SHARED")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpi_file_seek_shared__ (MPI_Fint *fh,MPI_Offset *offset,int *whence, int *ierr ) __attribute__ ((weak, alias ("pmpi_file_seek_shared__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpi_file_seek_shared (MPI_Fint *fh,MPI_Offset *offset,int *whence, int *ierr ) __attribute__ ((weak, alias ("pmpi_file_seek_shared")));
#else
void FORTRAN_API mpi_file_seek_shared_ (MPI_Fint *fh,MPI_Offset *offset,int *whence, int *ierr ) __attribute__ ((weak, alias ("pmpi_file_seek_shared_")));
#endif
...
void FORTRAN_API mpi_file_seek_shared_(MPI_Fint *fh,MPI_Offset *offset,int *whence, int *ierr )
{
    MPI_File fh_c;
