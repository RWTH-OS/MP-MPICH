/* 
 *   $Id: set_viewf.c 3732 2005-07-14 14:11:52Z tobias $    
 *
...
#if defined(FORTRANCAPS)
void FORTRAN_API MPI_FILE_SET_VIEW (MPI_Fint *fh,MPI_Offset *disp,MPI_Datatype *etype,
   MPI_Datatype *filetype,char *datarep,MPI_Fint *info, int *ierr,
   int str_len ) __attribute__ ((weak, alias ("PMPI_FILE_SET_VIEW")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
void FORTRAN_API mpi_file_set_view__ (MPI_Fint *fh,MPI_Offset *disp,MPI_Datatype *etype,
   MPI_Datatype *filetype,char *datarep,MPI_Fint *info, int *ierr,
   int str_len ) __attribute__ ((weak, alias ("pmpi_file_set_view__")));
#elif !defined(FORTRANUNDERSCORE)
void FORTRAN_API mpi_file_set_view (MPI_Fint *fh,MPI_Offset *disp,MPI_Datatype *etype,
   MPI_Datatype *filetype,char *datarep,MPI_Fint *info, int *ierr,
   int str_len ) __attribute__ ((weak, alias ("pmpi_file_set_view")));
#else
void FORTRAN_API mpi_file_set_view_ (MPI_Fint *fh,MPI_Offset *disp,MPI_Datatype *etype,
   MPI_Datatype *filetype,char *datarep,MPI_Fint *info, int *ierr,
   int str_len ) __attribute__ ((weak, alias ("pmpi_file_set_view_")));
#endif
...
void FORTRAN_API mpi_file_set_view_(MPI_Fint *fh,MPI_Offset *disp,MPI_Datatype *etype,
   MPI_Datatype *filetype,char *datarep,int str_len,MPI_Fint *info, int *ierr)
{
#else
void FORTRAN_API mpi_file_set_view_(MPI_Fint *fh,MPI_Offset *disp,MPI_Datatype *etype,
   MPI_Datatype *filetype,char *datarep,MPI_Fint *info, int *ierr,
...
#ifdef MP_MPICH
	*ierr = MPI_ERR_ARG;
	MPIR_ERROR(MPIR_COMM_WORLD,MPI_ERR_OTHER,"MPI_File_set_view: datarep is an invalid address");
	return;
#else
        FPRINTF(stderr, "MPI_File_set_view: datarep is an invalid address\n");
        MPI_Abort(MPI_COMM_WORLD, 1);
...
#ifdef MP_MPICH
	*ierr = MPI_ERR_ARG;
	MPIR_ERROR(MPIR_COMM_WORLD,MPI_ERR_OTHER,"MPI_File_set_view: datarep is a blank string");
	return;
#else
	FPRINTF(stderr, "MPI_File_set_view: datarep is a blank string\n");
        MPI_Abort(MPI_COMM_WORLD, 1);
