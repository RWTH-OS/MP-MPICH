...
int MPI_File_read_all_end(MPI_File mpi_fh, void *buf,
	MPI_Status *status) __attribute__ ((weak, alias ("PMPI_File_read_all_end")));
...
{
    int error_code;
    static char myname[] = "MPI_File_read_all_end";
