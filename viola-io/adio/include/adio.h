...
/* 
 *   $Id: adio.h,v 1.3 2005/03/11 09:02:09 mhs Exp $    
 *
...
typedef struct ADIOI_FileD {
    ...
    int ind_info_change;    /* independent info change, checked in ad_tunnelfs */
#endif
} ADIOI_FileD;
...
#define ADIO_TUNNELFS            161   /* Tunnelfs: Remote I/O with MPI */
#define ADIO_MEMFS               162   /* Memfs: Memory filesystem developed for VIOLA */
