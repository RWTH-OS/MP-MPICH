...
int ADIOI_MEMFS_ReadDone(ADIO_Request *request, ADIO_Status *status, int *error_code)  
{
#ifndef NO_AIO
    int done=0;
#if defined(MPICH2) || !defined(PRINT_ERR_MSG)
    static char myname[] = "ADIOI_MEMFS_READDONE";
#endif
#ifdef AIO_SUN 
...
int ADIOI_MEMFS_WriteDone(ADIO_Request *request, ADIO_Status *status, int *error_code)  
{
    return ADIOI_MEMFS_ReadDone(request, status, error_code);
} 
