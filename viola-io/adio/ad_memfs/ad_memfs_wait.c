...
void ADIOI_MEMFS_ReadComplete(ADIO_Request *request, ADIO_Status *status, int *error_code)  
{

#ifndef NO_AIO
#if defined(MPICH2) || !defined(PRINT_ERR_MSG)
    static char myname[] = "ADIOI_MEMFS_READCOMPLETE";
#endif
#ifdef AIO_SUN 
...
#ifdef DEBUG_MEMFS
    printf("ADIOI_MEMFS_ReadComplete called\n");
#endif
...
void ADIOI_MEMFS_WriteComplete(ADIO_Request *request, ADIO_Status *status, int *error_code)  
{
    ADIOI_MEMFS_ReadComplete(request, status, error_code);
}
