...
/* 
 *   $Id: iread_at.c,v 1.1.1.1 2005/03/10 16:07:13 mhs Exp $    
 *
                      ...
                      MPIO_Request *request)
{
	...
	errcode = MPI_File_read_at(fh, offset, buf, count, datatype, status); 
                      ...
                      MPIO_Request *request)
{
    ...
    ADIOI_TEST_DEFERRED(fh, "MPI_File_iread_at", &error_code);
