...
/* 
 *   $Id: iwrite.c,v 1.1.1.1 2005/03/10 16:07:13 mhs Exp $    
 *
                    ...
                    MPI_Datatype datatype, MPIO_Request *request)
{
	...
	bufsize = datatype_size * count;
        if (!(fh->atomicity))
            ...
            /* FIXME:
             * for tunnelfs atomicity could be easiliy handled on server side,
             * so there would be no need to distinguish here */
