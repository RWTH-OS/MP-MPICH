/* pingpingsync - based on pingpong, but sending at the same time
					using synchronous calls MPI_Send */
...
void ping2( int from );
void ping3a( int to, int from );
void ping3b( int from );
...
void ping1( int to, int from ) {
  ...
  printf("pingping with MPI_Send synchronous send\n");
