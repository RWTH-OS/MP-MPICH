...
int main() {
	...
	sequence_init();
	tcp_init();
	conn1 = tcp_add_connection("134.130.62.94",2500,"134.130.62.98",2500,CONN_CLIENT);
	/*	tcp_add_ip(conn1, "134.130.62.94",2501,"134.130.62.98",2501 );
	tcp_add_ip(conn1, "134.130.62.94",2502,"134.130.62.98",2502 );
	tcp_add_ip(conn1, "134.130.62.94",2503,"134.130.62.98",2503 ); */
