/*
 *  $Id: bsendutil2.c,v 1.4 2004/04/01 10:52:37 boris Exp $
 *
	...
	int dummy )
{
	...
	*error_code = MPI_SUCCESS;
    ...
    MPID_Request_init( (MPI_Request)(&(bsend_request)->shandle), MPIR_SEND );
