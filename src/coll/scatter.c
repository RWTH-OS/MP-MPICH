...
EXPORT_MPI_API int MPI_Scatter ( void *sendbuf, int sendcnt, MPI_Datatype sendtype, 
				void *recvbuf, int recvcnt, MPI_Datatype recvtype, int root, 
				MPI_Comm comm ) __attribute__ ((weak, alias ("PMPI_Scatter")));
	...
	MPI_Comm comm )
{
  ...
  struct MPIR_DATATYPE     *stype_ptr=0;
  struct MPIR_DATATYPE     *rtype_ptr=0;
