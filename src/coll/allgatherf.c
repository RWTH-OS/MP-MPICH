...
#if defined(FORTRANCAPS)
EXPORT_MPI_API void MPI_ALLGATHER ( void *, MPI_Fint *, MPI_Fint *, void *,
	MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("PMPI_ALLGATHER")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
EXPORT_MPI_API void mpi_allgather__ ( void *, MPI_Fint *, MPI_Fint *, void *,
	MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_allgather__")));
#elif !defined(FORTRANUNDERSCORE)
EXPORT_MPI_API void mpi_allgather ( void *, MPI_Fint *, MPI_Fint *, void *,
	MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_allgather")));
...
EXPORT_MPI_API void mpi_allgather_ ( void *, MPI_Fint *, MPI_Fint *, void *,
	MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_allgather_")));
#endif
...
EXPORT_MPI_API void FORTRAN_API mpi_allgather_ ANSI_ARGS(( void *, MPI_Fint *, MPI_Fint *, void *, 
                                               MPI_Fint *, MPI_Fint *, MPI_Fint *, 
				               MPI_Fint * ));

EXPORT_MPI_API void FORTRAN_API mpi_allgather_ ( void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype,
