...
#if defined(FORTRANCAPS)
EXPORT_MPI_API void MPI_ALLTOALLV ( void *, MPI_Fint *, MPI_Fint *,
	MPI_Fint *, void *, MPI_Fint *, MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("PMPI_ALLTOALLV")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
EXPORT_MPI_API void mpi_alltoallv__ ( void *, MPI_Fint *, MPI_Fint *,
	MPI_Fint *, void *, MPI_Fint *, MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_alltoallv__")));
#elif !defined(FORTRANUNDERSCORE)
EXPORT_MPI_API void mpi_alltoallv ( void *, MPI_Fint *, MPI_Fint *,
	MPI_Fint *, void *, MPI_Fint *, MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_alltoallv")));
#else
EXPORT_MPI_API void mpi_alltoallv_ ( void *, MPI_Fint *, MPI_Fint *,
	MPI_Fint *, void *, MPI_Fint *, MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_alltoallv_")));
#endif
...
EXPORT_MPI_API void FORTRAN_API mpi_alltoallv_ ANSI_ARGS(( void *, MPI_Fint *, MPI_Fint *, MPI_Fint *, 
				void *, MPI_Fint *, MPI_Fint *, MPI_Fint *, 
				MPI_Fint *, MPI_Fint * ));

EXPORT_MPI_API void FORTRAN_API mpi_alltoallv_ ( void *sendbuf, MPI_Fint *sendcnts, MPI_Fint *sdispls, MPI_Fint *sendtype, 
