/*
 *  $Id: cart_sub.c,v 1.2 2003/06/05 11:50:38 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Cart_sub ( MPI_Comm comm, int *remain_dims,
				MPI_Comm *comm_new ) __attribute__ ((weak, alias ("PMPI_Cart_sub")));
