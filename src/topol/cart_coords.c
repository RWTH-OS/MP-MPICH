/*
 *  $Id: cart_coords.c,v 1.2 2003/06/05 11:50:38 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Cart_coords ( MPI_Comm comm, int rank, int maxdims,
				int *coords ) __attribute__ ((weak, alias ("PMPI_Cart_coords")));
