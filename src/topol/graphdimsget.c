/*
 *  $Id: graphdimsget.c,v 1.2 2003/06/05 11:50:38 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Graphdims_get ( MPI_Comm comm, int *nnodes,
				int *nedges ) __attribute__ ((weak, alias ("PMPI_Graphdims_get")));
