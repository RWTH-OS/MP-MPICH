/*
 *  $Id: cart_get.c,v 1.2 2003/06/05 11:50:38 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Cart_get (MPI_Comm comm, int maxdims, int *dims,
				int *periods, int *coords) __attribute__ ((weak, alias ("PMPI_Cart_get")));
