/*
 *  $Id: graphcreate.c,v 1.2 2003/06/05 11:50:38 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Graph_create ( MPI_Comm comm_old, int nnodes,
				int *index, int *edges, int reorder,
				MPI_Comm *comm_graph ) __attribute__ ((weak, alias ("PMPI_Graph_create")));
