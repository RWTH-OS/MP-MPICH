/*
 *  $Id: cart_map.c,v 1.2 2003/06/05 11:50:38 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Cart_map (MPI_Comm comm_old, int ndims, int *dims,
				int *periods, int *newrank) __attribute__ ((weak, alias ("PMPI_Cart_map")));
