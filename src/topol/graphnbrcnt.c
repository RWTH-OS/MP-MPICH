/*
 *  $Id: graphnbrcnt.c,v 1.2 2003/06/05 11:50:38 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Graph_neighbors_count ( MPI_Comm comm, int rank,
				int *nneighbors ) __attribute__ ((weak, alias ("PMPI_Graph_neighbors_count")));
