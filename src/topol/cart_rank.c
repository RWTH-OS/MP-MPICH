/*
 *  $Id: cart_rank.c,v 1.2 2003/06/05 11:50:38 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Cart_rank (MPI_Comm comm, int *coords, 
				int *rank ) __attribute__ ((weak, alias ("PMPI_Cart_rank")));
