/*
 *  $Id: errorstring.c,v 1.3 2003/06/05 11:50:34 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Error_string( int errorcode, char *string,
				int *resultlen ) __attribute__ ((weak, alias ("PMPI_Error_string")));
