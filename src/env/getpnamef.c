...
#if defined(FORTRANCAPS)
EXPORT_MPI_API void MPI_GET_PROCESSOR_NAME ( char *, MPI_Fint *, MPI_Fint *,
	MPI_Fint ) __attribute__ ((weak, alias ("PMPI_GET_PROCESSOR_NAME")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
EXPORT_MPI_API void mpi_get_processor_name__ ( char *, MPI_Fint *, MPI_Fint *,
	MPI_Fint ) __attribute__ ((weak, alias ("pmpi_get_processor_name__")));
#elif !defined(FORTRANUNDERSCORE)
EXPORT_MPI_API void mpi_get_processor_name ( char *, MPI_Fint *, MPI_Fint *,
	MPI_Fint ) __attribute__ ((weak, alias ("pmpi_get_processor_name")));
#else
EXPORT_MPI_API void mpi_get_processor_name_ ( char *, MPI_Fint *, MPI_Fint *,
	MPI_Fint ) __attribute__ ((weak, alias ("pmpi_get_processor_name_")));
#endif
...
EXPORT_MPI_API void FORTRAN_API mpi_get_processor_name_( char *name, MPI_Fint d, MPI_Fint *len, MPI_Fint *ierr )
#else
/* Prototype to suppress warnings about missing prototypes */
EXPORT_MPI_API void FORTRAN_API mpi_get_processor_name_ ANSI_ARGS(( char *, MPI_Fint *, 
                                         MPI_Fint *, MPI_Fint ));

EXPORT_MPI_API void FORTRAN_API mpi_get_processor_name_( char *name, MPI_Fint *len, MPI_Fint *ierr, MPI_Fint d )
#endif
{
  char cres[MPI_MAX_PROCESSOR_NAME];
  int l_len;
    ...
    l_len  = LOCAL_MIN( (int)strlen( cres ), (int)d );
    *len = l_len;
    *ierr = MPI_SUCCESS;
}
#endif
