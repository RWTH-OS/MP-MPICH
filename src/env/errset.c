/*
 *  $Id: errset.c,v 1.4 2003/06/05 11:50:34 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Errhandler_set( MPI_Comm comm,
				MPI_Errhandler errhandler ) __attribute__ ((weak, alias ("PMPI_Errhandler_set")));
