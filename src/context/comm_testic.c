/*
 *  $Id: comm_testic.c,v 1.2 2003/06/05 11:50:33 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Comm_test_inter ( MPI_Comm comm,
				int *flag ) __attribute__ ((weak, alias ("PMPI_Comm_test_inter")));
