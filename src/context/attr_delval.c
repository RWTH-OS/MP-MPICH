/*
 *  $Id: attr_delval.c,v 1.2 2003/06/05 11:50:33 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Attr_delete ( MPI_Comm comm,
				int keyval ) __attribute__ ((weak, alias ("PMPI_Attr_delete")));
