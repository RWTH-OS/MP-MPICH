/*
 *  $Id: groupcompare.c,v 1.2 2003/06/05 11:50:33 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Group_compare ( MPI_Group group1, MPI_Group group2,
				int *result ) __attribute__ ((weak, alias ("PMPI_Group_compare")));
