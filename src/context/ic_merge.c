/*
 *  $Id: ic_merge.c,v 1.3 2003/06/05 11:50:33 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Intercomm_merge ( MPI_Comm comm, int high,
				MPI_Comm *comm_out ) __attribute__ ((weak, alias ("PMPI_Intercomm_merge")));
