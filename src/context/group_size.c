/*
 *  $Id: group_size.c,v 1.2 2003/06/05 11:50:33 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Group_size ( MPI_Group group,
				int *size ) __attribute__ ((weak, alias ("PMPI_Group_size")));
