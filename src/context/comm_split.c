/*
 *  $Id: comm_split.c,v 1.3 2003/06/05 11:50:33 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Comm_split ( MPI_Comm comm, int color, int key,
				MPI_Comm *comm_out ) __attribute__ ((weak, alias ("PMPI_Comm_split")));
