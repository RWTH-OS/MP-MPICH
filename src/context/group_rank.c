/*
 *  $Id: group_rank.c,v 1.2 2003/06/05 11:50:33 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Group_rank ( MPI_Group group,
				int *rank ) __attribute__ ((weak, alias ("PMPI_Group_rank")));
