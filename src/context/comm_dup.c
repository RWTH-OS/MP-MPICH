/*
 *  $Id: comm_dup.c,v 1.4 2003/06/05 11:50:33 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Comm_dup (MPI_Comm comm,
				MPI_Comm *comm_out ) __attribute__ ((weak, alias ("PMPI_Comm_dup")));
