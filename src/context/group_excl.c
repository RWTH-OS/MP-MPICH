/*
 *  $Id: group_excl.c,v 1.2 2003/06/05 11:50:33 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Group_excl ( MPI_Group group, int n, int *ranks,
				MPI_Group *newgroup ) __attribute__ ((weak, alias ("PMPI_Group_excl")));
