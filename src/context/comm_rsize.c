/*
 *  $Id: comm_rsize.c,v 1.2 2003/06/05 11:50:33 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Comm_remote_size ( MPI_Comm comm,
				int *size ) __attribute__ ((weak, alias ("PMPI_Comm_remote_size")));
