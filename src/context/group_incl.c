/*
 *  $Id: group_incl.c,v 1.2 2003/06/05 11:50:33 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Group_incl ( MPI_Group group, int n, int *ranks,
				MPI_Group *group_out ) __attribute__ ((weak, alias ("PMPI_Group_incl")));
