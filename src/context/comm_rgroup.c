/*
 *  $Id: comm_rgroup.c,v 1.2 2003/06/05 11:50:33 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Comm_remote_group ( MPI_Comm comm,
				MPI_Group *group ) __attribute__ ((weak, alias ("PMPI_Comm_remote_group")));
