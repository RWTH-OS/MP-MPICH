/* 
 *   $Id: info_getnks.c,v 1.2 2003/06/05 11:50:35 rainer Exp $    
 *
...
EXPORT_MPI_API int MPI_Info_get_nkeys(MPI_Info info,
				int *nkeys) __attribute__ ((weak, alias ("PMPI_Info_get_nkeys")));
