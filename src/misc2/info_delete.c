/* 
 *   $Id: info_delete.c,v 1.2 2003/06/05 11:50:35 rainer Exp $    
 *
...
EXPORT_MPI_API int MPI_Info_delete(MPI_Info info,
				char *key) __attribute__ ((weak, alias ("PMPI_Info_delete")));
