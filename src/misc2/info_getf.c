/* 
 *   $Id: info_getf.c,v 1.5 2003/06/13 09:39:37 rainer Exp $    
 *
...
#if defined(FORTRANCAPS)
EXPORT_MPI_API void MPI_INFO_GET (MPI_Fint *, char *, MPI_Fint *, char *,
	MPI_Fint *, MPI_Fint *, MPI_Fint,
	MPI_Fint) __attribute__ ((weak, alias ("PMPI_INFO_GET")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
EXPORT_MPI_API void mpi_info_get__ (MPI_Fint *, char *, MPI_Fint *, char *,
	MPI_Fint *, MPI_Fint *, MPI_Fint,
	MPI_Fint) __attribute__ ((weak, alias ("pmpi_info_get__")));
#elif !defined(FORTRANUNDERSCORE)
EXPORT_MPI_API void mpi_info_get (MPI_Fint *, char *, MPI_Fint *, char *,
	MPI_Fint *, MPI_Fint *, MPI_Fint,
	MPI_Fint) __attribute__ ((weak, alias ("pmpi_info_get")));
...
EXPORT_MPI_API void mpi_info_get_ (MPI_Fint *, char *, MPI_Fint *, char *,
	MPI_Fint *, MPI_Fint *, MPI_Fint,
	MPI_Fint) __attribute__ ((weak, alias ("pmpi_info_get_")));
#endif
...
EXPORT_MPI_API void FORTRAN_API mpi_info_get_(MPI_Fint *info, char *key, MPI_Fint keylen, 
					      MPI_Fint *valuelen, char *value, MPI_Fint valspace,
					      MPI_Fint *flag, MPI_Fint *__ierr)
#else
/* Prototype to suppress warnings about missing prototypes */
EXPORT_MPI_API void FORTRAN_API mpi_info_get_ (MPI_Fint *, char *, MPI_Fint *, char *,
			      MPI_Fint *, MPI_Fint *, MPI_Fint, MPI_Fint);

/* Definitions of Fortran Wrapper routines */
EXPORT_MPI_API void FORTRAN_API mpi_info_get_(MPI_Fint *info, char *key, MPI_Fint *valuelen, char *value, 
