/*
 *  $Id: rsend_init.c,v 1.5 2003/06/05 11:50:37 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Rsend_init( void *buf, int count, MPI_Datatype datatype, int dest, 
	...
	MPI_Request *request ) __attribute__ ((weak, alias ("PMPI_Rsend_init")));
		    ...
		    int tag, MPI_Comm comm, MPI_Request *request )
{
    ...
    /* This is IDENTICAL to the create_send code except for the send function */
    MPIR_ALLOCFN(shandle,MPID_PSend_alloc,
