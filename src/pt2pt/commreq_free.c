/*
 *  $Id: commreq_free.c,v 1.4 2003/06/05 11:50:37 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Request_free( MPI_Request *request ) __attribute__ ((weak, alias ("PMPI_Request_free")));
