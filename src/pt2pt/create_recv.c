/*
 *  $Id: create_recv.c,v 1.4 2003/06/05 11:50:37 rainer Exp $
 *
		   ...
		   int tag, MPI_Comm comm, MPI_Request *request )
{
    ...
    MPIR_ALLOCFN(rhandle,MPID_PRecv_alloc,comm_ptr,MPI_ERR_EXHAUSTED,myname );
    ...
    MPID_Request_init((MPI_Request)&(rhandle->rhandle), MPIR_PERSISTENT_RECV );
