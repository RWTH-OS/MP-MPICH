...
#if defined(FORTRANCAPS)
EXPORT_MPI_API void MPI_TYPE_HINDEXED ( MPI_Fint *, MPI_Fint [], MPI_Fint [],
	MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("PMPI_TYPE_HINDEXED")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
EXPORT_MPI_API void mpi_type_hindexed__ ( MPI_Fint *, MPI_Fint [], MPI_Fint [],
	MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_type_hindexed__")));
#elif !defined(FORTRANUNDERSCORE)
EXPORT_MPI_API void mpi_type_hindexed ( MPI_Fint *, MPI_Fint [], MPI_Fint [],
	MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_type_hindexed")));
...
EXPORT_MPI_API void mpi_type_hindexed_ ( MPI_Fint *, MPI_Fint [], MPI_Fint [],
	MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_type_hindexed_")));
#endif
...
EXPORT_MPI_API void FORTRAN_API mpi_type_hindexed_ ( MPI_Fint *, MPI_Fint [], MPI_Fint [], 
                                    MPI_Fint *, MPI_Fint *, MPI_Fint * );

EXPORT_MPI_API void FORTRAN_API mpi_type_hindexed_( MPI_Fint *count, MPI_Fint blocklens[], MPI_Fint indices[], MPI_Fint *old_type, MPI_Fint *newtype, MPI_Fint *__ierr )
{
    MPI_Aint     *c_indices;
