/*
 *  $Id: startall.c,v 1.2 2003/06/05 11:50:37 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Startall( int count,
				MPI_Request array_of_requests[] ) __attribute__ ((weak, alias ("PMPI_Startall")));
