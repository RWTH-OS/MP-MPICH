...
#if defined(FORTRANCAPS)
EXPORT_MPI_API void MPI_UNPACK ( void *, MPI_Fint *, MPI_Fint *, void *,
	MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("PMPI_UNPACK")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
EXPORT_MPI_API void mpi_unpack__ ( void *, MPI_Fint *, MPI_Fint *, void *,
	MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_unpack__")));
#elif !defined(FORTRANUNDERSCORE)
EXPORT_MPI_API void mpi_unpack ( void *, MPI_Fint *, MPI_Fint *, void *,
	MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_unpack")));
#else
EXPORT_MPI_API void mpi_unpack_ ( void *, MPI_Fint *, MPI_Fint *, void *,
	MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_unpack_")));
#endif
...
EXPORT_MPI_API void FORTRAN_API mpi_unpack_ ANSI_ARGS(( void *, MPI_Fint *, MPI_Fint *, void *, 
                             MPI_Fint *, MPI_Fint *, MPI_Fint *, 
                             MPI_Fint * ));

EXPORT_MPI_API void FORTRAN_API mpi_unpack_ ( void *inbuf, MPI_Fint *insize, MPI_Fint *position, void *outbuf, MPI_Fint *outcount, MPI_Fint *type, MPI_Fint *comm, 
		   MPI_Fint *__ierr )
{
    int l_position;
