/*
 *  $Id: create_send.c,v 1.6 2003/06/05 11:50:37 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Send_init( void *buf, int count, MPI_Datatype datatype, int dest, 
	...
	MPI_Request *request ) __attribute__ ((weak, alias ("PMPI_Send_init")));
		   ...
		   int tag, MPI_Comm comm, MPI_Request *request )
{
    ...
    /* Save the information about the operation, being careful with ref-counted items */
