/*
 *  $Id: waitsome.c,v 1.3 2003/06/05 11:50:37 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Waitsome( 
	...
	MPI_Status array_of_statuses[] ) __attribute__ ((weak, alias ("PMPI_Waitsome")));
