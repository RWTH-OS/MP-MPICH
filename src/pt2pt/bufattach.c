/*
 *  $Id: bufattach.c,v 1.2 2003/06/05 11:50:37 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Buffer_attach( void *buffer, int size ) __attribute__ ((weak, alias ("PMPI_Buffer_attach")));
