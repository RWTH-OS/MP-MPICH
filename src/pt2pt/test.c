/*
 *  $Id: test.c,v 1.2 2003/06/05 11:50:37 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Test (MPI_Request  *request, int *flag,
				MPI_Status *status) __attribute__ ((weak, alias ("PMPI_Test")));
