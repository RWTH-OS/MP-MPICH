/*
 *  $Id: type_extent.c,v 1.2 2003/06/05 11:50:37 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Type_extent( MPI_Datatype datatype,
				MPI_Aint *extent ) __attribute__ ((weak, alias ("PMPI_Type_extent")));
