/*
 *  $Id: pack_size.c,v 1.2 2003/06/05 11:50:37 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Pack_size ( int incount, MPI_Datatype datatype,
				MPI_Comm comm, int *size ) __attribute__ ((weak, alias ("PMPI_Pack_size")));
