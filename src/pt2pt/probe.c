/*
 *  $Id: probe.c,v 1.2 2003/06/05 11:50:37 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Probe( int source, int tag, MPI_Comm comm,
				MPI_Status *status ) __attribute__ ((weak, alias ("PMPI_Probe")));
