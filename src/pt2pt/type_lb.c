/*
 *  $Id: type_lb.c,v 1.2 2003/06/05 11:50:37 rainer Exp $
 *
...
EXPORT_MPI_API int MPI_Type_lb ( MPI_Datatype datatype,
				MPI_Aint *displacement ) __attribute__ ((weak, alias ("PMPI_Type_lb")));
