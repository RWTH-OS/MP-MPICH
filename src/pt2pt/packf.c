...
#if defined(FORTRANCAPS)
EXPORT_MPI_API void MPI_PACK ( void *, MPI_Fint *, MPI_Fint *, void *,
	MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("PMPI_PACK")));
#elif defined(FORTRANDOUBLEUNDERSCORE)
EXPORT_MPI_API void mpi_pack__ ( void *, MPI_Fint *, MPI_Fint *, void *,
	MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_pack__")));
#elif !defined(FORTRANUNDERSCORE)
EXPORT_MPI_API void mpi_pack ( void *, MPI_Fint *, MPI_Fint *, void *,
	MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_pack")));
...
EXPORT_MPI_API void mpi_pack_ ( void *, MPI_Fint *, MPI_Fint *, void *,
	MPI_Fint *, MPI_Fint *, MPI_Fint *,
	MPI_Fint * ) __attribute__ ((weak, alias ("pmpi_pack_")));
#endif
...
EXPORT_MPI_API void FORTRAN_API mpi_pack_ ANSI_ARGS(( void *, MPI_Fint *, MPI_Fint *, void *, 
                           MPI_Fint *, MPI_Fint *, MPI_Fint *, MPI_Fint * ));

EXPORT_MPI_API void FORTRAN_API mpi_pack_ ( void *inbuf, MPI_Fint *incount, MPI_Fint *type, void *outbuf, MPI_Fint *outcount, MPI_Fint *position, MPI_Fint *comm, 
		 MPI_Fint *__ierr )
{
    int lposition;
