...
/*retrieve kind and class of code //si*/
#define CODE_TO_CLASS(code) (code & 63)
#define CODE_TO_KIND(code) (code >>MPIR_ERR_CLASS_BITS)
...
#define MPIR_ERR_ERRHANDLER_TYPE 63 /*The errhandler is of wrong type*/

#ifdef INCLUDE_IO_ERRORS
...
/* MPI_ERR_INFO_VALUE  */
#define MPIR_ERR_INFO_VALUE_TOOLONG 3
#define MPIR_ERR_INFO_VALUE_EMPTY 5
/* MPI_ERR_INFO_NOKEY  */
/* MPI_ERR_IO          */
/* MPI_ERR_NAME        */
/* MPI_ERR_NOMEM       */
