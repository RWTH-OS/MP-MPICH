...
#ifdef WIN32
/* The Compaq VisualFortran compiler per default only uses the
   least significant bit to distinguish between .true. and .false. 
   Others (PowerStation/Salford/Intel) use 1/0 values.
