...
/* for the META-Environment, we need different communicators 
   ...
   META_MPI_MAX_METAHOSTS is not bigger than the available index
   space.*/
#define MPI_COMM_HOST 150
#define MPI_COMM_LOCAL 151
/* 	MP i think this is not needed
...
IMPORT_MPI_API int    MPI_META_Get_metahost_name(char *, int *);
#endif
  /* /META */
